        ...
        <Grid container className={classes.head}>
            ...
            <Grid item md={11}>
              <Grid container>
                  ...
                  <Grid item md={1}>
                  <Typography align="left" className={classes.title} variant="body2">Debt #</Typography>
                  </Grid>
                  <Grid item md={1}>
                  ...
                  <Grid item md={2}>
                  <Typography align="left" className={classes.title} variant="body2">Description</Typography>
                  </Grid>
                  <Grid item md={1}>
                  <Typography align="left" className={classes.title} variant="body2">In Stock Week</Typography>
                  </Grid>
                  <Grid item md={1}>
                  <Typography align="left" className={classes.title} variant="body2">Price</Typography>
                  </Grid>
                  <Grid item md={1}/>
              </Grid>
            </Grid>
