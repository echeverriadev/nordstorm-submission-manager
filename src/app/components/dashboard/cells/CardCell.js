    ...
    return (
      <Card className={classes.card}>
        <CardContent className={classes.cardContent}>
          ...
          <Grid container>
            <Grid item md={1}>
                <img className={classes.img} alt="complex" src="https://www.knittedhome.com/communities/5/004/012/872/235/images/4628207884.jpg" />
            </Grid>
            <Grid item md={11}>
              <Grid className={classes.row} container direction="row" alignContent='center' alignItems='center'>
                  ...
                  <Grid item md={1}>
                    <TextField
                      ...
                      margin="normal"
                      value={item.dept}
                      onChange={e => onChange(index, "dept", e.target.value)}
                    />
                  </Grid>
                  <Grid item md={1}>
                    <TextField
                  ...
                  <Grid item md={1}>
                    <TextField
                      ...
                      margin="normal"
                      value={item.sg}
                      onChange={e => onChange(index, "sg", e.target.value)}
                    />
                  </Grid>
                  <Grid item md={1}>
                    <TextField
